...
const ContactInput = (props) => (
    <input type={props.type} name={props.name} class="block border-gray-200 bg-gray-50 focus:bg-white mb-3 px-4 py-3 border rounded w-full text-gray-700 leading-tight appearance-none focus:outline-none" placeholder={props.placeholder} required />
);

const ContactTextarea = (props) => (
    <textarea class="block border-gray-200 focus:border-gray-500 bg-gray-50 focus:bg-white mb-3 px-4 py-3 border rounded w-full text-gray-700 leading-tight appearance-none focus:outline-none" name={props.name} rows="6" placeholder={props.placeholder} required></textarea>
);
